          ...
          <div class="col-12 col-lg-5 text-center">
            <a href="{{ home_url() }}" aria-label="Accueil">
              <img src="@asset('images/logo-lepitch.png')"
                   class="logo" alt="Agence Wordpress Paris et Nice" class="logo mb-4 mt-4" width="200px" height="48px"
