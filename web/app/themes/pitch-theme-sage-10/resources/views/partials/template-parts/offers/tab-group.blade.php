      ...
      <div class="wp-card">
        ...
        <div class="card-body d-flex flex-column justify-content-between">
          <div class="d-flex flex-column wp-heading">
            <span class="price mb-1" style="font-size: 28px;">Sur devis</span>
          ...
          <div class="wp-excerpt">
            ...
            <a href="#"  data-bs-toggle="modal" data-bs-target="#essentielGroupModal" aria-label="Souscrire une offre"
      ...
      <div class="wp-card">
        ...
        <div class="card-body d-flex flex-column justify-content-between">
          ...
          <div class="wp-excerpt">
            ...
            <a href="#"  data-bs-toggle="modal" data-bs-target="#sereniteGroupModal" aria-label="Souscrire une offre"
               class="cta text-center">Souscrire à l'offre</a>
          </div>
        </div>
      </div>
      ...
      <div class="wp-card">
        ...
        <div class="card-body d-flex flex-column justify-content-between">
          ...
          <div class="wp-excerpt">
            ...
            <a href="#"  data-bs-toggle="modal" data-bs-target="#premiumGroupModal" aria-label="Souscrire une offre"
               class="cta text-center">Souscrire à l'offre</a>
          </div>
        </div>
      </div>
...
<!-- Modal -->
<div class="modal fade" id="essentielGroupModal" tabindex="-1" aria-labelledby="essentielGroupModalLabel" aria-hidden="true">
...
<div class="modal fade" id="sereniteGroupModal" tabindex="-1" aria-labelledby="seriniteGroupModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0">
...
<div class="modal fade" id="premiumGroupModal" tabindex="-1" aria-labelledby="premiemGroupModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header border-0">
